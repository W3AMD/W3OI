...
if ($task ne "SAME") {
  print ("<META HTTP-EQUIV=\"Refresh\" CONTENT=\"80;URL=http://65.200.152.251");
  print ("/cgi-bin/uncgi/fortune-long?PROCID=$$&TASK=DEL\">");
...
print "<TD ALIGN=\"center\"><A HREF=\"/cgi-bin/uncgi/fortune-long?PROCID=$procid&TASK=DEL\">Another Cookie</A>";
print "<TD ALIGN=\"center\"><A HREF=\"/cgi-bin/uncgi/fortune-long?PROCID=$procid&TASK=SAME\">Stop!</A>";
print "<TD ALIGN=\"center\"><A HREF=\"/cgi-bin/uncgi/fortune-long?PROCID=$procid&TASK=STOP\">Hawk Home</A>";
