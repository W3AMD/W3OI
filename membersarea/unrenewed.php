...
echo "<h4>Expired members for year $thisyear</h4>";
//get list of expired members:
$sql="SELECT * FROM members m ";
$sql.="JOIN paid p ";
$sql.="ON m.member_id = p.member_id ";
$sql.="WHERE p.year = '$lastyear-12-31' AND ";
$sql.="m.member_id NOT IN ( SELECT x.member_id ";
$sql.="FROM members x ";
$sql.="JOIN paid y ";
$sql.="ON x.member_id = y.member_id ";
$sql.="WHERE y.year = '$thisyear-12-31') ";
$sql.="ORDER BY m.lname ";
//echo $sql . '<br>';
$Recordset = mysql_query($sql, $W3OITesting) or die(mysql_error());
while( $row = mysql_fetch_assoc ( $Recordset ) )
{
    echo $row['lname'] . ', ' . $row['fname'] . ', ' . $row ['suffix'] . ', ' .$row['fcccall'] . "<br>";
}
