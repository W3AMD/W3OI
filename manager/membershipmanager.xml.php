...
<object class="MembershipController" name="MembershipController" baseclass="Page">
  ...
  <object class="Panel" name="LoginPanel" >
    ...
    <object class="Label" name="Label1" >
      <property name="Alignment">agCenter</property>
      <property name="Animations">a:0:{}</property>
      <property name="Caption">W3OI Membership Controller</property>
      <property name="Color">#3399FF</property>
      <property name="Font">
    ...
    <object class="Edit" name="Username" >
      ...
      <property name="ParentFont">0</property>
      <property name="Text">w3oitreasury</property>
      <property name="Top">48</property>
    ...
    <object class="Edit" name="Password" >
      ...
      <property name="ParentFont">0</property>
      <property name="Text">#Lo171en</property>
      <property name="Top">95</property>
      <property name="Width">121</property>
    </object>
  ...
  <object class="Panel" name="ButtonPanel" >
    ...
    <object class="Button" name="UpdatePayments" >
      <property name="Animations">a:0:{}</property>
      <property name="ButtonType">btNormal</property>
      <property name="Caption">Received Payments</property>
      <property name="Color">Silver</property>
      <property name="Height">25</property>
      <property name="Left">298</property>
      <property name="Name">UpdatePayments</property>
      <property name="ParentColor">0</property>
      <property name="Top">8</property>
      <property name="Width">115</property>
      <property name="OnClick">LogInClick</property>
    </object>
    <object class="Button" name="SelectOfficers" >
      <property name="Animations">a:0:{}</property>
      <property name="ButtonType">btNormal</property>
      <property name="Caption">Select Officers</property>
      <property name="Color">Silver</property>
      <property name="Height">25</property>
      <property name="Left">434</property>
      <property name="Name">SelectOfficers</property>
      <property name="ParentColor">0</property>
      <property name="Top">8</property>
      <property name="Width">115</property>
      <property name="OnClick">LogInClick</property>
    </object>
    <object class="Button" name="SelectBoard" >
      <property name="Animations">a:0:{}</property>
      <property name="ButtonType">btNormal</property>
      <property name="Caption">Select Board</property>
      <property name="Color">Silver</property>
      <property name="Height">25</property>
      <property name="Left">434</property>
      <property name="Name">SelectBoard</property>
      <property name="ParentColor">0</property>
      <property name="Top">48</property>
      <property name="Width">115</property>
      <property name="OnClick">LogInClick</property>
