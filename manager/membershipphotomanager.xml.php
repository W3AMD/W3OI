<?php
<object class="MembershipPhotoController" name="MembershipPhotoController" baseclass="Page">
  ...
  <property name="Name">MembershipPhotoController</property>
  ...
  <object class="Panel" name="LoginPanel" >
    ...
    <object class="Label" name="Label1" >
      <property name="Alignment">agCenter</property>
      <property name="Animations">a:0:{}</property>
      <property name="Caption">W3OI Membership Photo Controller</property>
      <property name="Color">#66FF99</property>
      <property name="Font">
