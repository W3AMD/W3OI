<?php
<object class="AnnouncementController" name="AnnouncementController" baseclass="Page">
  <property name="Animations">a:0:{}</property>
  <property name="Background"></property>
  <property name="Caption">Announce Ctrl</property>
  <property name="Color">#6666FF</property>
  <property name="Height">495</property>
  <property name="HiddenFields">a:0:{}</property>
  <property name="Name">AnnouncementController</property>
  ...
  <object class="Panel" name="LoginPanel" >
    ...
    <object class="Label" name="Label1" >
      <property name="Alignment">agCenter</property>
      <property name="Animations">a:0:{}</property>
      <property name="Caption">W3OI Announcement Controller</property>
      <property name="Color">#6666FF</property>
      <property name="Font">
